            ...
            <main className={styles.responsiveMain}>
              <div className={styles.textContainer}> 
                ...
                <p className={`${styles.justificado} ${styles.text}`}>
                  ...
                  A Vitrine Criativa edição São João 2024 pode ser encontrada no Pólo de Eventos da Serra Negra. Verifique a  <a href="/#mapa" className="map-link"> localização no mapa</a>.
                </p>
              </div>
